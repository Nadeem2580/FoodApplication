    ...
    return (
        <Box sx={{ display: 'flex' }}>
            ...
            >
                ...
                <Divider />
                <List>
                    {[{ title: "Dashboard", url: "/vendor-dashboard", icon: <DashboardIcon sx={{ color: "#8dc63f" }} /> },
                    { title: "Restaurants", url: "/vendor-restaurant", icon: <RestaurantMenuIcon sx={{ color: "#8dc63f" }} /> },
